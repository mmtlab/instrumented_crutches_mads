/*
 ...
 |_|   |_|_|\__\___|_|    | .__/|_|\__,_|\__, |_|_| |_|
                          |_|            |___/         
# A Template for Filter_templatePlugin, a Filter Plugin
# Generated by the command: C:\Program Files\MADS\usr\local\bin\mads-plugin.exe -t filter -d C:\mirrorworld\instrumented_crutches\filter_template filter_template
# Hostname: unknown
...
#ifndef PLUGIN_NAME
#define PLUGIN_NAME "filter_template"
#endif
...
class Filter_templatePlugin : public Filter<json, json> {
...
*/
INSTALL_FILTER_DRIVER(Filter_templatePlugin, json, json);
